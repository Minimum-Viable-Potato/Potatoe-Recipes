...
// this function generates the array of selected ingredients to render to page
function listQ(){
...
function renderCheck() { 
  ...
  if (localStorage.getItem('selected potatoes') && (firstTime === 1)){
    ...
    for (var i = 0; i<selectedIngArr.length; i++){
      ...
      console.log('localstorage'+checkbox.id, selectedIngArr)
...
function removebutton(event){
  ...
  console.log('ingredient array before clearing:'+ selectedIngArr);
  // var checkboxSelectionsArr = [];
  // var checkbox = document.getElementById('checkbox')
  // console.log(checkbox, checkboxSelectionsArr)
  ...
  console.log('ingredient array after clearing:'+ selectedIngArr);
}
...
function clearCheckboxes(){
  ...
  for (var i = 0; i < (checkboxElements.length); i++){
    ...
    // var label = labels[i];
    //check to see if each checkbox is checked
    if (checkboxElement.checked){
      // console.log (checkboxElement.checked === true)
